...
This repository is currently in **Module 12: AI Question Answering UI**. The
frontend can inspect analyzed projects, open source files, and ask
source-grounded questions with citations backed by the project registry.
...
- [Module 12 AI Question Answering UI](docs/module-12-ai-question-answering.md)
...
Module 12 can be validated without installing dependencies:
